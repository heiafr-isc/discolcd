#ifndef ADAFRUITGFX_HPP_
#define ADAFRUITGFX_HPP_
...
class AdafruitGFX {
   public:
    AdafruitGFX(int16_t w, int16_t h);  // Constructor
...
class AdafruitGFX_Button {
   public:
    AdafruitGFX_Button(void);
    // "Classic" initButton() uses center & size
    void initButton(AdafruitGFX* gfx,
                    int16_t x,
                    int16_t y,
                    uint16_t w,
                    uint16_t h,
    ...
    void initButtonUL(AdafruitGFX* gfx,
                      int16_t x1,
                      int16_t y1,
                      uint16_t w,
                      uint16_t h,
...
class GFXcanvas1 : public AdafruitGFX {
   public:
...
class GFXcanvas8 : public AdafruitGFX {
   public:
...
class GFXcanvas16 : public AdafruitGFX {
   public:
